...
suspend fun postInsertNewClaim(
    ...
    val postUrl =
        "$baseUrl?userId=$userId&indexUpdateClaim=$indexUpdateClaim&newClaimDes=$newClaimDescription&newClaimPho=$newClaimPhoto&newClaimLoc=$newClaimLocation&newClaimSta=$newClaimStatus"
